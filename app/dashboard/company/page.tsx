...
import CompanyFormModal from "@/components/company/CompanyModal";
...
export default function CompanyPage() {
  ...
  const handleToggleStatus = async (id: string, currentStatus: boolean) => {
    const res = await putApi(`/companies/${id}/change-status`, {
  ...
  const handleDelete = async (id: string) => {
    ...
    const res = await deleteApi(`/companies/${id}`);
    if (res.success) {
      toast.success(res.message || "Company deleted successfully"); // refresh list
